...
public final class SimulatedPortfolioData {
    ...
    public static List<SimulatedTransRecord> entries() {
        ...
        records.add(SimulatedTransRecord.stockBuy("2016-01-10", "2330", 5_000, 150, 750_000, "建倉"));
        records.add(SimulatedTransRecord.stockBuy("2016-01-10", "2317", 5_000, 80, 400_000, "建倉"));
        records.add(SimulatedTransRecord.stockBuy("2016-01-10", "2377", 2_000, 50, 100_000, "建倉（自家公司）"));
        records.add(SimulatedTransRecord.stockBuy("2016-01-10", "2884", 20_000, 18, 360_000, "建倉"));
        records.add(SimulatedTransRecord.stockBuy("2016-01-10", "2609", 10_000, 9.5, 95_000, "建倉"));
        ...
        // --- 2017 ---
        records.add(SimulatedTransRecord.stockBuy("2017-02-10", "2377", 1_000, 75, 75_000, "紀律加碼"));
        ...
        // --- 2018 ---
        records.add(SimulatedTransRecord.stockBuy("2018-02-10", "2377", 1_000, 85, 85_000, "紀律加碼"));
        ...
        records.add(SimulatedTransRecord.cashReduction(
                "2018-10-18", "2317", 1_155, 2, 11_550, "減資 20%，每股退 2 元"));

        // --- 2019 ---
        records.add(SimulatedTransRecord.stockSell("2019-01-15", "2609", 4_673, 8.5, 39_720, "認賠出場 (含稅費概算)"));
        records.add(SimulatedTransRecord.stockBuy("2019-02-10", "2377", 1_000, 85, 85_000, "紀律加碼"));
        ...
        // --- 2020 ---
        records.add(SimulatedTransRecord.stockBuy("2020-02-10", "2377", 1_000, 110, 110_000, "紀律加碼"));
        ...
        // --- 2021 ---
        records.add(SimulatedTransRecord.stockBuy("2021-02-10", "2377", 1_000, 150, 150_000, "紀律加碼"));
        ...
        // --- 2022 ---
        records.add(SimulatedTransRecord.stockBuy("2022-02-10", "2377", 1_000, 120, 120_000, "紀律加碼"));
        ...
        // --- 2023 ---
        records.add(SimulatedTransRecord.stockBuy("2023-02-10", "2377", 1_000, 160, 160_000, "紀律加碼"));
        ...
        // --- 2024 ---
        records.add(SimulatedTransRecord.stockBuy("2024-02-10", "2377", 1_000, 180, 180_000, "紀律加碼"));
        records.add(SimulatedTransRecord.stockSell("2024-06-15", "2317", 4_620, 200, 924_000, "達標停利全數出清"));
        records.add(SimulatedTransRecord.stockSell("2024-07-10", "2330", 2_000, 900, 1_800_000, "逢高獲利了結部分持股"));
        ...
        // --- 2025 ---
        records.add(SimulatedTransRecord.stockBuy("2025-02-10", "2377", 1_000, 190, 190_000, "紀律加碼"));
        records.add(SimulatedTransRecord.stockBuy("2025-02-15", "2884", 10_000, 28, 280_000, "現金過多，增加防禦部位"));
