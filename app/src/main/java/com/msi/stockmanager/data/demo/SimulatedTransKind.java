...
public enum SimulatedTransKind {
    ...
    STOCK_DIVIDEND(TransType.TRANS_TYPE_STOCK_DIVIDEND),
    CASH_REDUCTION(TransType.TRANS_TYPE_CASH_REDUCTION),
    STOCK_REDUCTION(TransType.TRANS_TYPE_STOCK_REDUCTION);
